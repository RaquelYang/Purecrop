<template>
  <div id="brand">
    <v-container>
      ...
      <!-- <p class="text-center mt-6 mt-lg-10">雲林土地 x 小農產品</p> -->
      <v-row class="brandtext">
        ...
        <div class="d-flex midcontent">
          ...
          <v-col cols="12" md="6" class="d-flex align-center text-center">
            <div class="text">
              <h2 class="text-h3 font-weight-bold">雲林小農</h2>
              <p class="text-h6 mt-6 px-8">後，他表示農業不該侷限於「農民」，並以種植作物需施肥噴藥、畜牧業需要獸醫為例，將種植與畜牧的第一線生產者，以及加工買賣業的第二線業者等，皆歸入農業的一環。「想像與現實是有落差的」，鬼王以實際走訪農村的經驗，顛覆民眾對於傳統農業的想像。鬼王指出，台灣農業的問題之一，客觀的面對農產規格問題，更加著重於技術與經營管理層面。</p>
            </div>
          </v-col>
        </div>
        <div class="timeline">
          <v-timeline >
            <v-timeline-item class="">
              <v-img position="bottom center" class="timelineimg"  src="@/assets/images/undraw_blooming_jtv6.svg"></v-img>
              ...
              <v-timeline-item class=" text-right">
                <v-img height="200px" position="top center" class="timelineimg1"  src="@/assets/images/undraw_friendship_mni7.svg"></v-img>
              ...
              <v-timeline-item class="">
                <v-img height="200px" position="top center" class="timelineimg"  src="@/assets/images/undraw_software_engineer_re_fyew.svg"></v-img>
                <h4 class="text-h4 grey--text text--darken-1">2021/6</h4>
              ...
              <v-timeline-item class=" text-right">
                <v-img position="bottom center" class="timelineimg1"  src="@/assets/images/undraw_nature_benefits_re_kk70.svg"></v-img>
    ...
    <div class="grey lighten-3 position">
      <v-container class="mt-6 mt-lg-16">
        <h3 class="text-center text-lg-h2 text-md-h3 text-h3 light-green--text text--darken-1 font-weight-bold bottomline mt-16">小農位置</h3>
        <v-row class="mt-10">
          <v-col></v-col>
          <v-col cols="12" md="9">
            <v-row class="mt-6 mt-lg-8 mb-16">
              ...
              <v-col cols="6">
                <p class="text-h2 font-weight-bold grey--text text--darken-3">交通方式</p>
                <p class="text-h4 font-weight-medium pt-10">汽車</p>
                <p class="text-h6">國道3號南下至雲林出口後右轉三民路約開10公里</p>
                <p class="text-h4 font-weight-medium">高鐵</p>
                <p class="text-h6">搭至雲林高鐵站後轉搭快速公路212號至田寮二路下車</p>
                <p class="text-h4 font-weight-medium">台鐵</p>
                <p class="text-h6">搭置台鐵雲林站於台鐵前站搭綠55至田寮仔路下車</p>
              </v-col>
            </v-row>
          </v-col>
          <v-col></v-col>
